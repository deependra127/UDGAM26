    ...
    return (
            <section className="our-team">
                  <div className='Heading'>
                    <div style={{color: '#FFF9F0', fontSize: 116.78, fontFamily: 'Montserrat', fontWeight: '900', wordWrap: 'break-word'}}>OUR TEAM</div>
                  </div>
            <div className='meet-our-heads'>
                <div className="col1">
                    <div className='image-container1' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>

                    <div className='image-container2' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    <img src={subtract} className="subtract-left" />
                    </div>

                    <div className='image-container3' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>

                    <div className='image-container4' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>
                </div>
                ...
                <div className="card">
                            <img src={convenerPhoto} alt="profile" />
                ...
                <div className='image-container6' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>

                <div className='image-container7' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>
                ...
                <div className="col3">
                    ...
                    <div className='image-container8' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>

                    <div className='image-container9' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>

                    <div className='image-container10' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>
                ...
                <div className='image-container11' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>

                <div className='image-container12' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                    <div className='POR'>CONVENER</div>
                    </div>

                <div className='image-container13' style={{backgroundImage: `url(${convenerPhoto})`, backgroundSize: 'cover', noRepeat: 'no-repeat', backgroundPosition: 'center'}}>
                    <div className='Name'>TANISH AGARWAL</div>
                        <div className='POR'>CONVENER</div>
            ...
            <div className='managers-heading'>
                    <div style={{color: '#FFF9F0', fontSize: 80, fontFamily: 'Montserrat', fontWeight: '900', wordWrap: 'break-word'}}>OUR MANAGERS</div>
                </div>
